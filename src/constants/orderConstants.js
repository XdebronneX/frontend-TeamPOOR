...
// export const CONTINUE_ORDER_REQUEST = 'CONTINUE_ORDER_REQUEST';
// export const CONTINUE_ORDER_SUCCESS = 'CONTINUE_ORDER_SUCCESS';
// export const CONTINUE_ORDER_FAIL = 'CONTINUE_ORDER_FAIL'

export const ORDER_CONTINUE_REQUEST = 'ORDER_CONTINUE_REQUEST'
export const ORDER_CONTINUE_SUCCESS = 'ORDER_CONTINUE_SUCCESS'
export const ORDER_CONTINUE_FAIL = 'ORDER_CONTINUE_FAIL'
