...
export const verifyUserEmail = (token, id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/verify/email/${token}/${id}`,
      config
    );
...
export const viewAllNotif = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/user-notification/unread`,
      { withCredentials: true }
    );
...
export const updateNotifs = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${process.env.REACT_APP_API}/api/v1/user-notification/${id}`,
      { withCredentials: true }
    );
    dispatch({
...
export const viewAllUsers = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/view/all/users`,
      { withCredentials: true }
    );
...
export const viewAllSuppliers = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_API}/api/v1/admin/view/all/suppliers`,
      { withCredentials: true }
    );
...
export const updateUser = (id, userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${process.env.REACT_APP_API}/api/v1/admin/users/${id}`,
      userData,
      config
    );
    dispatch({
