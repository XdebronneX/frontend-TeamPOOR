...
//                   .map((supplierUser) => (
//                     <option key={supplierUser._id} value={supplierUser._id}>
...
//             </FormControl>
//             <FormControl mb={4} flex="1" mr={4}>
//               <FormLabel htmlFor="dateDelivered_field">
//                 Date Delivered
//               </FormLabel>
//               <Input
//                 type="date"
        ...
        >
          ...
          >
            <FormControl mb={4} flex="1" mr={4}>
              ...
              {errors.supplier && <span>Supplier is required</span>}
            </FormControl>
            <FormControl mb={4} flex="1" mr={4}>
              <FormLabel htmlFor="dateDelivered_field">
                Date Delivered
              ...
              />
              {errors.dateDelivered && <span>Date Delivered is required</span>}
            </FormControl>
          </Box>
          <Box
            display="flex"
          ...
          >
            <FormControl mb={4} flex="1" mr={4}>
              ...
              />
              {errors.invoiceId && <span>Invoice ID is required</span>}
            </FormControl>
            <FormControl mb={4} flex="1">
              <FormLabel htmlFor="totalPrice_field">Total Price</FormLabel>
              <Input
          ...
          <FormControl mb={4} flex="1">
            ...
            {errors.productId && <span>Product is required</span>}
          </FormControl>
          <Table variant="striped" colorScheme="gray" size="md">
            <Thead>
              <Tr>
